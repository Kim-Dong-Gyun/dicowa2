        ...
        <section id="section">
            ...
            <input type="hidden" name = "bno" value="${boardDto.bno }">
				...
				<div class="comment-box">
                    <h5>댓글란</h5>
                    <form name="replyForm" method="post" action="/replyWriteE">
    ...
    <script>
      ...
      $(function(){
          $('#modifyBtn').click(function() {
          	alert("글을 수정합니다.");
          	location.href="/updateEvent?bno=${boardDto.bno}";
          });
        });  
      ...
      $(document).ready(function(){
			...
			//댓글 수정 View
			 $(".replyUpdateBtn").on("click", function(){
				location.href = "/replyUpdateViewE?bno=${boardDto.bno}"
								+ "&page=${scri.page}"
		...
		//댓글 삭제 View
			$(".replyDeleteBtn").on("click", function(){
				location.href = "/replyDeleteViewE?bno=${boardDto.bno}"
					+ "&page=${scri.page}"
					+ "&perPageNum=${scri.perPageNum}"
					+ "&searchType=${scri.searchType}"
					+ "&keyword=${scri.keyword}"
